...
# for iso3 codes
iso3_code <- read.xlsx("~/WHO-Project/data/CLASS.xls", 1)
...
# for iso2 codes
iso2_code <- read.xlsx("~/WHO-Project/data/iso_2digit_alpha_country_codes.xls",1)
...
#if iso_code3 country names don't match with WHO, paste in new column
